...
public class SearchProductController extends HttpServlet {
    ...
    private static final String SUCESS="productManagement.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<TeaDTO> listTea=dao.getListTea(search);
            System.out.println(listTea);
            request.setAttribute("LIST_TEA", listTea);
            List<CategoryDTO> listCategory=dao.getListCategory();
            request.setAttribute("LIST_CATE", listCategory);
            if(listTea!=null && listCategory!=null){
                url=SUCESS;
            }
        } catch (Exception e) {
